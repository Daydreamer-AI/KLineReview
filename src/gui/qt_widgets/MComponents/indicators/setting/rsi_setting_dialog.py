...
class RsiSettingDialog(QDialog):
    def __init__(self, parent=None):
        super(RsiSettingDialog, self).__init__(parent)
        uic.loadUi('./src/gui/qt_widgets/MComponents/indicators/setting/RsiSettingDialog.ui', self)
    ...
    def init_para(self):
        ...
        self.dict_setting_object = {
            0: RsiSettingObject(0, self.lineEdit_ma_period, self.checkBox_ma, self.lineEdit_line_width, self.btn_color),
            1: RsiSettingObject(1, self.lineEdit_ma_period_1, self.checkBox_ma_1, self.lineEdit_line_width_1, self.btn_color_1),
            2: RsiSettingObject(2, self.lineEdit_ma_period_2, self.checkBox_ma_2, self.lineEdit_line_width_2, self.btn_color_2)
        }
