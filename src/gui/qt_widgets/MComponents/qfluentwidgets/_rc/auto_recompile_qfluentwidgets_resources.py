...
默认输入: ./src/gui/qt_widgets/MComponents/qfluentwidgets/_rc/resource.qrc
默认输出: ./src/gui/qt_widgets/MComponents/qfluentwidgets/_rc/resource.py
...
# 定义默认路径
DEFAULT_QRC_FILE = "./src/gui/qt_widgets/MComponents/qfluentwidgets/_rc/resource.qrc"
DEFAULT_OUTPUT_FILE = "./src/gui/qt_widgets/MComponents/qfluentwidgets/_rc/resource.py"

def compile_qrc_file(qrc_file_path=DEFAULT_QRC_FILE, output_file_path=DEFAULT_OUTPUT_FILE, compiler_type="pyqt5"):
    """
    手动编译指定的 .qrc 文件
    
    :param qrc_file_path: .qrc 文件的路径，默认为 ./src/gui/qt_widgets/MComponents/qfluentwidgets/_rc/resource.qrc
    :param output_file_path: 输出的 _rc.py 文件路径，默认为 ./src/gui/qt_widgets/MComponents/qfluentwidgets/_rc/resource.py
